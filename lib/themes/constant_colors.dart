...
class ConstantColors {
  static Color primary = const Color(0xff937308);
  static Color blue = const Color(0xff0873FF);
  static Color yellow = const Color(0xff937308);//const Color(0xffEAA501);
  static Color yellow1 = const Color(0xff937308); //const Color(0xffFFC003);
