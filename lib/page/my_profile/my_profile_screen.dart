  ...
  buildShowDetails({
    ...
    return ListTile(
      leading: Column(
        ...
        children: <Widget>[
          Container(
              ...
              decoration: BoxDecoration(color: const Color(0xff937308).withOpacity(0.2), borderRadius: const BorderRadius.all(Radius.circular(6))),
              child: Icon(
                iconData,
                size: 30,
                color: ConstantColors.primary,
      ...
      title: Padding(
        ...
        child: Text(
          title,
          style: const TextStyle(fontSize: 12, color: Color(0xff9090AD)),
        ),
      ),
