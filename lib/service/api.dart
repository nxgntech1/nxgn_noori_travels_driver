...
class API {
  static const baseUrl = "https://nadmin.nxgnapp.com/api/v1/"; // live
  static const apiKey = "base64:6HufCppuLdK3u1SpXpCn3/rpQpYmUm0Cf8Co/eF7xXo=";
  ...
  static const sendOtpSignup = "${baseUrl}usersignup";
  static const otpVerifySignup = "${baseUrl}usersignup_checkotp";
